        ...
        <div class="col-md-12">
          <div class="box">
            ...
            @if (Request::get('keyword'))
                <a href="btn btn success" href="{{route('user.index')}}"></a>
            @else
                <a class="btn btn-success" href="{{route('user.create')}}"><span class="glyphicon glyphicon-plus"></span>Create</a>
            @endif
            <form method="get" action="{{route('user.index')}}">  <!-- mengakses user controller di function index untuk search -->
            ...
            @if(Request::get('keyword'))
                ...
                @include('alert.success') <!-- di cek status, jika ada maka ditampilkan -->
